...
// User aliases override built-in ones (~/.roidy/aliases.json)
const userAliases = loadJsonFile(join(homedir(), '.roidy', 'aliases.json'), {});
const ALIASES = { ...BUILTIN_ALIASES, ...userAliases };
